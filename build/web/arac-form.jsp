...
<div class="container">
	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				<c:if test="${arac != null}">
					<form action="updateArac" method="post">
				</c:if>
				<c:if test="${arac == null}">
					<form action="insertArac" method="post">
				</c:if>
				...
				<fieldset class="form-group">
					<label>Plaka No</label> <input type="text"
						value="<c:out value='${arac.plakaNo}' />" class="form-control"
						name="plakaNo" required="required">
				</fieldset>

				<fieldset class="form-group">
					<label>Marka</label> <input type="text"
						value="<c:out value='${arac.marka}' />" class="form-control"
						name="marka">
				</fieldset>
				<fieldset class="form-group">
					<label>Model</label> <input type="text"
						value="<c:out value='${arac.model}' />" class="form-control"
						name="model">
				</fieldset>
						<fieldset class="form-group">
					<label>Renk</label> <input type="text"
						value="<c:out value='${arac.renk}' />" class="form-control"
						name="renk">
				</fieldset>
